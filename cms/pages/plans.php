        ...
        <div class="row">
          <div class=" col-md-6">
            <div class="about_us_text_and_button">
              ...
              <h3 class="premium"><span class="gold">ПРЕМІУМ</span> ІНТЕРНЕТ-ЗАХИСТ </h3>

              <p class="about_us_text">Ідеальний вибір для користувачів, які потребують максимального захисту, включно з функціями розширеного виявлення загроз, захисту від крадіжки та управління паролями. Захищає пристрої Windows, Mac та Android.</p>
          ...
          <div class=" col-md-6">
            <!--            <div class="photo">-->
            <img class="photo_earth" src="styles/img/bitock_image.png" alt="">
            <!--            </div>-->
          </div>
        </div>
...
<div class="plan">
  ...
  <section class="table">
    <div class="row">
      ...
      <div class="col-3">
        <div class="tick_values"><img src="styles/img/tick.png" alt=""></div>
        <div class="line_row"></div>
      </div>
      <div class="col-3">
        <div class="row_values"><img src="styles/img/cross.png" alt=""></div>
        <div class="line_row"></div>
      </div>
      <div class="col-3">
        <div class="row_values"><img src="styles/img/cross.png" alt=""></div>
      ...
      <div class="col-3">
        <div class="row_values_long"><img src="styles/img/tick.png" alt=""></div>
        <div class="line_row"></div>
      </div>
      <div class="col-3">
        <div class="row_values_long"><img src="styles/img/tick.png" alt=""></div>
      ...
      <div class="col-3">
        <div class="row_values_long"><img src="styles/img/cross.png" alt=""></div>
        <div class="line_row"></div>
      </div>
      <div class="col-3">
      ...
      <div class="col-3">
        <div class="row_names">Захист від шкідливого
          програмного забезпечення, фішингу</div>
        <div class="line"></div>
      </div>
      <div class="col-3">
        <div class="row_values_long"><img src="styles/img/tick.png" alt=""></div>
